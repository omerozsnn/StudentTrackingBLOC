...
class MisbehaviourControlPage extends StatefulWidget {
  const MisbehaviourControlPage({super.key});

  @override
  _MisbehaviourControlPageState createState() =>
      _MisbehaviourControlPageState();
}

class _MisbehaviourControlPageState extends State<MisbehaviourControlPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Yaramazlık Kontrolü'),
        backgroundColor: Color(0xFF6C8997),
        elevation: 0,
        actions: [
          IconButton(
            icon: const Icon(Icons.add_circle_outline),
            tooltip: 'Yaramazlık Ekle',
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const MisbehaviourPage(),
                ),
              ).then((_) {

...
class SearchAndAddCourseCard extends StatelessWidget {
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Aramak veya eklemek için ders adını yazın. Düzenlemek için listeden bir ders seçin.',
